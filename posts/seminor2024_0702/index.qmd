...
$$
p_{X_1}(x_1)=\Sigma_{x_2 \in \mathcal{X_2}} \cdots \Sigma_{x_k \in \mathcal{X_k}} p(x_1,x_2,\ldots,x_k)
$$

であり、$(X_1,X_2)$の同時確率関数は次のようになる。

$$
p_{X_1,X_2}(x_1,x_2)=\Sigma_{x_3 \in \mathcal{X_3}} \cdots \Sigma_{x_k \in\mathcal{X_k} } p(x_1,x_2,\ldots,x_k)
$$

::: {.extra-space2}:::

::: {.callout-tip}
## $\Sigma_{x_i \in X_i}$とは

$\Sigma_{x_i \in X_i}$は$X_i$に入るすべての$X_i$に関して和を取ることを意味する。
:::
...
で与えられるとする。
分布関数$F(x,y)$は$0 \le x \le 1, 0 \le y \le 1$に対して、
